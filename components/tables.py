...
COLUMN_LABELS = {
    ...
    "robustness_flag": "Estabilidad del resultado",
    "robustness_flag_es": "Estabilidad del resultado",
    "signal_stability_label_es": "Estabilidad del resultado",
...
def _style_table(df: pd.DataFrame):
    ...
    stability_colors = {
        "Estable": "color: #287c67; font-weight: 700",
        "Sensible": "color: #d9902f; font-weight: 700",
        "Variable": "color: #64748b; font-weight: 700",
        "No clasificado": "color: #64748b; font-weight: 700",
    }
    coverage_colors = {
