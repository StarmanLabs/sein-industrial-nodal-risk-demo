...
with check_cols[0]:
    action_panel(
        ...
        "1. Confirmar si la señal es persistente o episódica. 2. Revisar meses con mayor prioridad operativa. 3. Comparar ranking estrés nodal/prioridad operativa. 4. Verificar estabilidad del resultado, cobertura analítica y soporte de contexto.",
    )
with check_cols[1]:
    action_panel(
